...
class QrCodeGenerateScreen extends StatelessWidget {
  ...
  Widget qrView(bool isWeb) {
    ...
    return WillPopScope(
      ...
      child: FocusDetector(
        ...
        child: Scaffold(
          backgroundColor: isWeb ? Colors.white : Colors.grey[50],
          appBar: CustomAppBar(
            title: 'QR Code',
            showBack: true,
            isWeb: isWeb,
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildQrCodeWidget(encodedData, isWeb),
                        SizedBox(height: isWeb ? 20 : 20.h),
                        Container(
                          padding: EdgeInsets.symmetric(
                            horizontal: isWeb ? 20 : 20.w,
                            vertical: isWeb ? 12 : 12.h,
                          ),
                          decoration: BoxDecoration(
                            color: AppColors.primaryGreen.withOpacity(0.1),
                  ...
                  Container(
                    width: double.infinity,
                    padding: EdgeInsets.all(isWeb ? 18 : 18.w),
                    decoration: BoxDecoration(
                      color: Colors.amber[50],
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: EdgeInsets.symmetric(vertical: isWeb ? 18 : 16.h),
                      ),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
  ...
  Widget _buildQrCodeWidget(String encodedData, bool isWeb) {
    if (encodedData.isEmpty) {
      return const CustomLoader();
    } else {
      return Container(
